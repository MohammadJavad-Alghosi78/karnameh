...
export { default as LikeIcon } from "./atoms/icons/Like";
export { default as DisLikeIcon } from "./atoms/icons/DisLike";
...
export { default as AnswerCard } from "./organisms/AnswerCard/container";
